...
## Introduction
This project was performed as the final course-project in CS-433 at EPFL. **Report is available in docs/**. The main focus of the project was to generate data for training YOLOv5s for detection of lego bricks. Brick types were restricted to: *2540, 3001, 3003, 3004, 3020, 3021, 3022, 3023, 3039, 3660*. As a result two main datasets were generated: 
